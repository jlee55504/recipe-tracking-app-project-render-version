          ...
          <tr style={ styling }>
            <td className="name-td">
              <label htmlFor="name">
                ...
                required={ true } value={ formData.name } 
                onChange={ handleChange } />
              </label>
            </td>
            <td className="cuisine-td">
              <label htmlFor="cuisine">
                <input type="text" id="cuisine" name="cuisine" 
                placeholder="Cuisine" required={ true } value={ formData.cuisine } 
                onChange={ handleChange } />
              </label>
            </td>
            ...
            <td className="preparation-td">
              <label htmlFor="preparation">
                <textarea id="preparation" name="preparation" 
                placeholder="Preparation" required={ true } cols={ 30 } rows={ 2 } 
                value={ formData.preparation } onChange={ handleChange } />
              </label>
            </td>
